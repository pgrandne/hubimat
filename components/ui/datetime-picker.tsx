...
export function DateTimePicker({
  ...
  const [hideTimeMod, setHideTimeMod] = useState( (timePicker.hour !== true && timePicker.minute !== true && timePicker.second !== true) || hideTime)
  ...
  const dislayFormat = useMemo(() => {
    ...
    return format(
      displayValue,
      `${!hideTimeMod ? 'MMM' : 'MMMM'} d, yyyy${!hideTimeMod ? ' '+getTimeFormat(timePicker, use12HourFormat ?? false) : ''}`
    );
  }, [displayValue, hideTimeMod, timePicker, use12HourFormat]);
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      ...
      <PopoverContent className="w-auto p-2 h-auto">
        ...
        <div className="flex flex-col gap-2 mt-2">
          {setTimePicker != undefined && <div className="flex items-center justify-between text-sm">
            <span className="items-center flex">
              <Checkbox className='mr-1' checked={timePicker?.hour} onCheckedChange={(checked) => {
                setHideTimeMod( !(checked === true || timePicker.minute === true || timePicker.second === true) )
                setTimePicker({hour:checked === true, minute:timePicker.minute, second:timePicker.second})
              }}/>
              Heures
            </span>
            <span className="items-center flex">
              <Checkbox className='mr-1' checked={timePicker?.minute} onCheckedChange={(checked) => {
                setHideTimeMod( !(checked === true || timePicker.hour === true || timePicker.second === true) )
                setTimePicker({hour:timePicker.hour, minute:checked === true, second:timePicker.second})
              }}/>
              Minutes
            </span>
            <span className="items-center flex">
              <Checkbox className='mr-1' checked={timePicker?.second} onCheckedChange={(checked) => {
                setHideTimeMod( !(checked === true || timePicker.hour === true || timePicker.minute === true) )
                setTimePicker({hour:timePicker.hour, minute:timePicker.minute, second:checked === true})
              }}/>
              Secondes
            </span>
          </div>}
...
function TimePicker({
  ...
  const display = useMemo(() => {
    return format(value, getTimeFormat(timePicker ?? {hour:true, minute:true, second:true}, use12HourFormat ?? false));
